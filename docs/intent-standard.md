...
TASK.yaml provides execution tracking for both `intent/` and `planning/` tasks. For intents, generated by `/intent-plan`. For planning, created manually or by TeamSwarm.
